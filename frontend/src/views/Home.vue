...
<style>
        :root {
            ...
            --light: #F0F4F8;
            --white: #FFFFFF;
            --gradient: linear-gradient(135deg, #0A4D68 0%, #05668D 50%, #00A8CC 100%);
            --shadow-sm: 0 2px 8px rgba(10, 77, 104, 0.08);
            --shadow-md: 0 8px 24px rgba(10, 77, 104, 0.12);
        ...
        * {
        ...
        .section-badge {
            ...
            background: linear-gradient(135deg, rgba(0, 217, 255, 0.1) 0%, rgba(10, 77, 104, 0.1) 100%);
            color: var(--primary);
